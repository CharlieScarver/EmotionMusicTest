...
{
    /// <summary>
    /// Intended to be used for 2D art which can scale in floating point increments such as hand drawn art.
    /// </summary>
    public class ScalableArtCamera : CameraBase
    {
        public ScalableArtCamera(Vector3 position, float zoom = 1) : base(position, zoom)
        {
        }
        ...
        public override void RecreateMatrix()
        {
            ...
            // Find the camera margin and scale FOV from the center.
